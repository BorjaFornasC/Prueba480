public class CD implements DispositivosAlmacenamiento{
    ...
    private final String TIPO_DE_LECTURA = "laser";

    public CD(String nombre, String capacidadAlmacenamiento, String contenido, String tipoDeDisco) {
        this.nombre = nombre;
